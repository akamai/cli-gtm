...
GOOS=linux GOARCH=arm64 go build -o build/akamai-gtm-$1-linuxarm64 .
shasum -a 256 build/akamai-gtm-$1-linuxarm64 | awk '{print $1}' > build/akamai-gtm-$1-linuxarm64.sig
